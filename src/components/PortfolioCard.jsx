        ...
        <div className="absolute inset-0 z-20 bg-gray-900/95 rounded-xl flex flex-col items-center justify-center gap-4 p-6 text-center">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              {isAdmin && !isOwner
                ? `Remove ${person.name}'s profile from the portfolio.`
                : 'Remove your profile from the portfolio.'}
            </p>
          </div>
          ...
          <div className="flex items-start justify-between gap-2">
            ...
            {canDelete && (
              <button
                ...
                title={isAdmin ? `Delete ${person.name}'s profile` : 'Delete your profile'}
                className="shrink-0 mt-0.5 p-1.5 rounded-lg text-gray-600 hover:text-red-400 hover:bg-red-900/20 transition-all"
              >
                <Trash2 size={16} />
              </button>
            )}
