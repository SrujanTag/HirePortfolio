...
* `src/`: Contains the React code (like the clickable cards and portfolio pages).
* `public/`: Contains the main `index.html` file.
* `package.json`: Lists the tools needed to run the app.

## 🚀 How to Run

1. Open your terminal and go into the `hireportfolio` folder.
2. Type `npm install` and press Enter to download the needed files.
3. Type `npm start` and press Enter to view the website in your browser.